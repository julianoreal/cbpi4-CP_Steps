...
def setup(cbpi):
    ...
    cbpi.plugin.register("CP_SpargeStep", CP_SpargeStep)    
    cbpi.plugin.register("CP_BoilStep", CP_BoilStep)
    cbpi.plugin.register("CP_Cooldown", CP_Cooldown)
    cbpi.plugin.register("CP_MashInStep", CP_MashInStep)
    cbpi.plugin.register("CP_MashStep", CP_MashStep)
